...
//    Result result = accountUseCase.sendVerificationMail(user1.getUid(), "sechan100@gmail.com", "/verify");
...
//    Result result = accountUseCase.sendVerificationMail(user1.getUid(), user1.getEmail(), "/verify");
...
//    result = accountUseCase.sendVerificationMail(user2.getUid(), user1.getEmail(), "/verify");
