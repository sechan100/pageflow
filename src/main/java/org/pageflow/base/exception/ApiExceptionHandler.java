...
import org.pageflow.base.exception.code.CommonApiStatusCode;
...
public class ApiExceptionHandler {
    ...
    public ResponseDto handleMethodArgumentNotValid(MethodArgumentNotValidException e) {
        ...
        return new ResponseDto(
                ApiStatus.FEEDBACK, // status
                CommonApiStatusCode.FIELD_VALIDATION_FAIL, // errorCode
                CommonApiStatusCode.FIELD_VALIDATION_FAIL.getMessage(), // message
                errors // data
        );
    }
