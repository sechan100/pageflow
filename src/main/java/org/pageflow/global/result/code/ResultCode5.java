 ...
 */
@Getter
public enum ResultCode5 implements ResultCode {
  // 5000: 서버 프로그램 에러
  ...
  ResultCode5(int code, String message) {
    this(code, message, null, null);
  }

  ResultCode5(int code, String message, Class<?> dataType) {
    this(code, message, dataType, null);
  }

  ResultCode5(int code, String message, Class<?> dataType, Class<? extends Collection> collectionType) {
    this.code = code;
