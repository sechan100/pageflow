...
export default function Chapter(props : chapterProps) {
  ...
  return (
    <div className="relative">
      ...
      <Link to={"/chapter/" + props.chapter.id} onMouseOver={toggleChapterFormLink} onMouseOut={toggleChapterFormLink} className="hidden absolute inline z-50 px-1 py-2 -ml-1 -mt-1 left-[2%] top-[17%] bg-gray-700 items-center text-white text-sm font-normal text-gray-900 rounded-lg transition duration-75 group" ref={chapterFormLink}>
