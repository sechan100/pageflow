...
export default function NewChapterBtn({outline: localOutline} : {outline : Outline}) {
  ...
  return (
    <button type="button" onClick={() => requestCreateChapter()} className="absolute z-20 top-5 px-1 md:px-5 left-[7%] py-2 text-xs font-medium text-center ext-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
      새 챕터
    </button>
  );
}